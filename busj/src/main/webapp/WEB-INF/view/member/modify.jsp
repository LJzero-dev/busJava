...
<div class="row">
	<div class="col-md-8 mb-3 m-auto">
		...
		<tr id="pwChangeform1" style="display: none;">
			<th>새 비밀번호</th>
			<td>
				<input type="password" class="form-control is-invalid" oninput="restrictPw(this)" onkeyup="checkPassword()" id="mi_pw" name="mi_pw" 
		...
		<tr id="pwChangeform2" style="display: none;">
			<th>새 비밀번호확인</th>
			<td>
				<input type="password" class="form-control is-invalid" oninput="restrictPw(this)" onkeyup="checkPassword()" id="mi_pw2" name="mi_pw2"
				placeholder="4-15자의 영문, 숫자, 특수문자로 입력해주세요." >
