      ...
      <div class="container">
        <div class="row text-center mb-5 probootstrap-animate">
          <div class="col-md-12">
            ...
            <p>
              고속버스 통합 예매 홈페이지에서 제공하는 다양한 서비스를 이용하기 위하여 고객님의 동의가 필요합니다.<br />
본 서비스는 만 14세 이상만 이용이 가능하며, 서비스 이용 전 아래 사항을 확인하시고 동의하여 주시기 바랍니다.
            </p>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 mb-3">
            <h5 class="text-left"><span class="text-danger">*</span>개인정보 수집 및 이용동의</h5>
        ...
        <div class="allchkbox">
          <input type="checkbox" id="all" name="all" onclick="chkAll();" /><label for="all">
        ...
        <button type="button" class="btn btn-primary" onclick="chkAgree();">동의함</button>
      </div>
      </div>
    </section>
