...
<section class="probootstrap_section">
	<div class="container">
		...
		3. 동물(단, 장애인 보조견 및 전용운반상자에 넣은 애완동물 제외)<br />
			...
			<div class="col-md-12">
				<div class="allchkbox">
				<input type="checkbox" id="chkAll"><label for="chkAll"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-check2" viewBox="0 0 16 16">
