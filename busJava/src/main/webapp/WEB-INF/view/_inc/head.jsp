...
<h1><a class="navbar-brand" href="/"><img src="${pageContext.request.contextPath}/resources/images/logo.png" /></a></h1>
	...
	<div class="collapse navbar-collapse justify-content-between" id="probootstrap-menu">
		<ul class="navbar-nav">
			...
			<li class="nav-item"><a class="nav-link" href="buyAgree">페이머니 구매</a></li>
			<li class="nav-item dropdown">
...
<% if (loginInfo != null) { %> <!-- 로그인 상태 -->
		<p class="mb-0"><%=loginInfo.getMi_id() %>님</p>
			<button class="btn btn-primary text-800 me-2" type="button" onclick="location.href='logout'">로그아웃</button>
...
<%} else { %>
			...
			<button class="btn order-0" type="button"><span class="text-primary">회원가입</span></button>
<%} %>
         </div>
         <!-- 로그인 상태 -->
         <!-- <div class="d-flex align-items-center">
